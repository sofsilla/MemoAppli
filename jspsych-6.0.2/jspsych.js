  ...
  core.init = function(options) {
    ...
    if(typeof opts.display_element == 'undefined'){
     ...
     // var body = document.querySelector('body');
      var body = document.getElementById('exp_contener');
...
*/      
      document.getElementById('exp_contener').style.margin = '0px';
      document.getElementById('exp_contener').style.height = '90%';
      document.getElementById('exp_contener').style.width = '100%';
      opts.display_element = document.getElementById('exp_contener');
    } else {
